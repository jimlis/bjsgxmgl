package com.zj.project.xm.xmqyjwz.controller;
...
public class XmQyjwzController extends AdminBaseController {
	...
	String XmQyjwz(){
	    return Constant.PC_PREFIX+"project/xm/xmqyjwz/xmQyjwz";
	}
	...
	String add(){
	    return Constant.PC_PREFIX+"project/xm/xmqyjwz/add";
	}
	...
	String edit(@PathVariable("id") Long id,Model model){
	    ...
	    return Constant.PC_PREFIX+"project/xm/xmqyjwz/edit";
	}
