package com.zj.project.xm.xmxmcjdw.controller;
...
public class XmXmcjdwController extends AdminBaseController {
	...
	String XmXmcjdw(){
	    return Constant.PC_PREFIX+"project/xm/xmxmcjdw/xmXmcjdw";
	}
	...
	String add(){
	    return Constant.PC_PREFIX+"project/xm/xmxmcjdw/add";
	}
	...
	String edit(@PathVariable("id") Long id,Model model){
	    ...
	    return Constant.PC_PREFIX+"project/xm/xmxmcjdw/edit";
	}
