package com.zj.platform.common.security;
...
public class DesUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		/*String str="uqMljpMd1rSW40elhZj6O/0WgfEd7qscIpF7VaFcUCY=";
		System.out.println(str.length());
		String str1=Des.decryption(str,"bj");
		System.out.println(str1);*/
/*		String tel="15310047117";
		long data=new Date().getTime();
		String str=tel+"_"+data;
		String en=Des.encryption(str, "bjsgxmgl_lfj");
		System.out.println(en);
*/		
		String str="TsBBpZH3587aXCgR1+zRzvoLPHlVohHm3fr5ooyhF38=";
		String dn=DesUtils.decryption(str, "bjsgxmgl_lfj");
